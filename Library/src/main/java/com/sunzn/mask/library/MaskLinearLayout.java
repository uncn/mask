...
public class MaskLinearLayout extends MaskAlphaLinearLayout implements IMaskLayout {

    private MaskLayoutHelper mLayoutHelper;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new MaskLayoutHelper(context, attrs, defStyleAttr, this);
    ...
    @Override
    public void setRadiusAndShadow(int radius, @MaskLayoutHelper.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    @Override
    public void setRadius(int radius, @MaskLayoutHelper.HideRadiusSide int hideRadiusSide) {
