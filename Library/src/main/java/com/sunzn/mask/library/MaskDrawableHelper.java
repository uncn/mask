 ...
 * @date 2016-03-17
 */
public class MaskDrawableHelper {
    private static final String TAG = MaskDrawableHelper.class.getSimpleName();
    ...
    public static Bitmap createBitmapFromView(View view, int leftCrop, int topCrop, int rightCrop, int bottomCrop) {
        Bitmap originBitmap = MaskDrawableHelper.createBitmapFromView(view);
