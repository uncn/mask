...
public class MaskResHelper {
    ...
    public static Drawable getAttrDrawable(Context context, Resources.Theme theme, int attr) {
        ...
        if (sTmpValue.resourceId != 0) {
            return MaskDrawableHelper.getVectorDrawable(context, sTmpValue.resourceId);
        }
        return null;
    }
    ...
    public static Drawable getAttrDrawable(Context context, TypedArray typedArray, int index) {
        ...
        if (value != null) {
            if (value.type != TypedValue.TYPE_ATTRIBUTE && value.resourceId != 0) {
                return MaskDrawableHelper.getVectorDrawable(context, value.resourceId);
            }
        }
        return null;
    }
    ...
    public static int getAttrDimen(Context context, int attrRes) {
        ...
        return TypedValue.complexToDimensionPixelSize(sTmpValue.data, MaskDisplayHelper.getDisplayMetrics(context));
    }
