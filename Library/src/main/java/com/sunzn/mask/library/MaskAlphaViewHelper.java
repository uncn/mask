...
public class MaskAlphaViewHelper {
    ...
    public MaskAlphaViewHelper(@NonNull View target) {
        mTarget = new WeakReference<>(target);
        mPressedAlpha = MaskResHelper.getAttrFloatValue(target.getContext(), R.attr.mask_alpha_pressed);
        mDisabledAlpha = MaskResHelper.getAttrFloatValue(target.getContext(), R.attr.mask_alpha_disabled);
    }

    public MaskAlphaViewHelper(@NonNull View target, float pressedAlpha, float disabledAlpha) {
        mTarget = new WeakReference<>(target);
